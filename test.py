...
app.layout = html.Div([
    ...
    dcc.Slider(id='brightness-slider', min=0.5, max=2, step=0.1, value=1, marks={i: str(i) for i in np.arange(0.5, 2.1, 0.5)}),
    dcc.Slider(id='contrast-slider', min=0.5, max=2, step=0.1, value=1, marks={i: str(i) for i in np.arange(0.5, 2.1, 0.5)}),
